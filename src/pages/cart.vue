            ...
            <ul class="cart-item-list">
              <li class="cart-item" v-for="(item,index) in list" v-bind:key="index">
                <div class="item-check">
                  <span class="checkbox" v-bind:class="{'checked':JSON.parse(item.productSelected)}"  @click="updateCart(item)"></span>
                </div>
                <div class="item-name">
                  <img v-lazy="'/imgs/'+item.productMainImage" alt="">
      ...
      methods:{
        ...
        updateCart(item,type){
          ...
          if(type == '-'){
            ...
            selected = !JSON.parse(item.productSelected);
          }
